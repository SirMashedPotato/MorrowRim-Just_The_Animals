...
namespace MorrowRim
{
    class JobGiver_DoDrugs : ThinkNode_JobGiver
	{
		protected override Job TryGiveJob(Pawn pawn)
		{
			...
			bool validator(Thing t) => t.def.category == ThingCategory.Item && t.def?.ingestible?.drugCategory == DrugCategory.Social  && t.IngestibleNow && pawn.RaceProps.CanEverEat(t) && pawn.CanReserve(t, 1, -1, null, false);
